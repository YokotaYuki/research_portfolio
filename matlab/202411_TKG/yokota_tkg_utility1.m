...
for i=1:11
    ...
    for j=1:11
        ...
        utility1(i,j) = (-lambda_offload1(i,j) + lambda_offload2(i,j) + 0.1*lambda1(i,j))*b + 100*(lambda_offload1(i,j)/lambda1(i,j)*(d_rq-E_offload1(i,j)) + lambda_nooffload1(i,j)/lambda1(i,j)*(d_rq-E_nooffload1(i,j)));
        utility2(i,j) = (-lambda_offload2(i,j) + lambda_offload1(i,j) + 0.1*lambda2(i,j))*b + 100*(lambda_offload2(i,j)/lambda2(i,j)*(d_rq-E_offload2(i,j)) + lambda_nooffload2(i,j)/lambda2(i,j)*(d_rq-E_nooffload2(i,j)));
    end
end
